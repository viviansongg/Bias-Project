...
def politicalReq(): # returns political bias score - /politicalReq?url= ...
...
@app.route('/citation', method=['GET'])
def citationReq(): # returns citation detail - /citationReq?url= ...
...
@app.route('/extension', method=['GET'])
def citationReq(): # returns citation detail - /citationReq?url= ...
...
def summaryReq(): # returns a gemini summary - /summaryReq?url= ...
